                    ...
                    <VStack flex={1} justifyContent="space-between">
                        <VStack>
                            ...
                            <VStack alignItems="center" mt="5">
                                <Heading mb="3" fontWeight="semibold">Glömt ditt lösenord</Heading>
                                <Text fontSize="sm" px={8} textAlign='center'>
                                            vänligen ange din e-postadress.
                                            du kommer att få en e-postlänk för att
                                             återställa lösenordet</Text>
                            </VStack>
                        </VStack>
                        <VStack>
                        ...
                        <VStack>
                            <HStack borderColor="#ff7e1a" borderBottomWidth={1} borderTopWidth={1} mt="5" borderTopRadius={5}>
                                <Button flex={1} py="4" borderRightColor="#ff7e1a" borderRightWidth={1} variant="ghost" >Glömt ditt lösenord</Button>
                           </HStack>
                        </VStack>
                    </VStack>
                </KeyboardAvoidingView>
